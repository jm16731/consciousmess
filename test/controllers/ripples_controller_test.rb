...
class RipplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ripple" do
    assert_difference('Ripple.count') do
      post ripples_url, params: { ripple: { date_posted: @ripple.date_posted, message: @ripple.message, name: @ripple.name, url: @ripple.url } }
    end
  ...
  test "should update ripple" do
    patch ripple_url(@ripple), params: { ripple: { date_posted: @ripple.date_posted, message: @ripple.message, name: @ripple.name, url: @ripple.url } }
